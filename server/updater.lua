if Config.UpdateCheck then
    ...
    CreateThread(function()
        PerformHttpRequest("https://raw.githubusercontent.com//Mathewgamingg/mg_scratchingserialnumber/master/version", VersionCheck, "GET")
    end)
